...
export enum SubscribeActions {
  ...
  SYNC_Y3MAKERIGNORE_STATE = 'SYNC_Y3MAKERIGNORE_STATE',
  // 获取工作区间文件列表
  ...
  TRIGGERT_CODEBASE_QUALITY_ISSUE_AUTOFIX = 'TRIGGERT_CODEBASE_QUALITY_ISSUE_AUTOFIX',
  ...
  // Skill 操作通知
  NOTIFY_SKILL_CONFIG_SUCCESS = 'NOTIFY_SKILL_CONFIG_SUCCESS',
  ...
  THEME_SELECT_CHANGED = 'THEME_SELECT_CHANGED',
  // 页面选择变化
  TABS_SELECT_CHANGED = 'TABS_SELECT_CHANGED',
  // 点击了设置按钮
  ONCLICK_SETTINGS = 'ONCLICK_SETTINGS',
