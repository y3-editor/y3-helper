    ...
    switch (newType) {
      ...
      case 'file':
        updatedRule.metaData = {
          ...rule.metaData,
          alwaysApply: false,
          globs: Array.isArray(rule.metaData.globs) ? rule.metaData.globs : []
        };
        break;
    }
    ...
    >
      ...
      >
        ...
        <ModalBody p={0} overflowY="auto" flex="1">
          {/* 规则列表 */}
          {rules.map((rule) => {
            // 将所有非始终生效的规则都设为指定文件模式
            const effectiveType = rule.metaData.alwaysApply ? 'always' : 'file';
                      ...
                      <Box mt="1">
                        ...
                        >
                          <Text
                            ...
                            whiteSpace="nowrap"
                          >
                            {SOURCE_TAG[rule.metaData.source || 'codemaker'] || 'Local'}
                          </Text>
                        </Box>
                      </Box>
                    </Box>
