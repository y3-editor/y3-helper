...
5. **CRITICAL: You MUST NOT call more than 2 tools in parallel in a single response.** If you need more information, call the first 2 tools, wait for results, then call additional tools in the next response. This is a hard limit that cannot be exceeded.
